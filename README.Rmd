...
setwd("~/OneDrive/Data/Census-trade/")
...
# US exports to Liberial all years sorted from most to least
...
# TODO: Finish this section plotting commodity by year
# TODO: Do this using small multiples
# https://www.sharpsightlabs.com/blog/small-multiples-ggplot/
# https://www.storybench.org/make-small-multiples-r-using-geom_line/
# https://r-graph-gallery.com/241-custom-layout-strip-ggplot2.html
