...
kable(top_20_ex, format.args = list(big.mark = ","))
...
kable(top_20_im, format.args = list(big.mark = ","))
...
rubber$YEAR <- parse_date_time(rubber$YEAR, "Y")
kable(select(rubber, YEAR, TOTAL), format.args = list(big.mark = ","))
